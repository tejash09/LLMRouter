...
class LLMRouter:
    ...
    def _calculate_complexity_fallback(self, prompt: str) -> float:
        ...
        complexity = (lexical_diversity * 0.5 +
                      normalized_avg_word_length * 0.5)
        return complexity
    ...
    async def generate(self, prompt: str) -> Tuple[str, str]:
        ...
        selected_model['avg_response_time'] = (
            selected_model['avg_response_time'] + response_time) / 2

        return generated_text, selected_model['name']
